# Django settings for isomero project.

import os

# The top directory for this project. Contains requirements/, manage.py,
# and README.rst, a isomero directory with settings etc (see
...
PROJECT_PATH = os.path.join(PROJECT_ROOT, 'isomero')
...
SECRET_KEY = ')ls-!rd(e=7a-=axi)&amp;k7nl!tmw2ys#f5@mt%7oi&amp;ql3r^fhco'
...
ROOT_URLCONF = 'isomero.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'isomero.wsgi.application'
